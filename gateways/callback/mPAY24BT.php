<?
/**
 * WHMCS Paymentmodule - Callback fole for mPay24 Bank Transfer Payment Gateway
 * 
 * @author Johannes Weber <jw@internex.at>
 * @version $Id:$
 */
$gatewayModule = "mPAY24BT";
...
if($_GET['confirm'] == 'true' && $_GET['OPERATION'] == 'CONFIRMATION' && $_GET['STATUS'] == 'BILLED')
{
	...
	try
	{
		if($token == $tokenGenerated)
		{
			...
			sendMessage("Bank Transfer Payment Confirmation", $id_invoice);
