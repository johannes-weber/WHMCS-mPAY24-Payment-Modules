<?
/**
 * WHMCS Paymentmodule - Callback fole for mPay24 Creditcard Payment Gateway
 * 
 * @author Johannes Weber <jw@internex.at>
 * @version $Id:$
 */
$gatewayModule = "mPAY24CC";
...
Description: ' . $description;
		...
		{
			throw new InvalidArgumentException('Requestet token != generated token! ('.$token.' != '.$tokenGenerated.')');
		}
	}
	catch(Exception $e)
	{
